...
Un invito personale che si comporta come un piccolo gioco. L'area privata consente a un solo amministratore di inserire un nome, aggiungere una frase personale, scegliere un giorno o un periodo, indicare i giorni consigliati, aggiungere facoltativamente una foto e generare un link univoco. Il destinatario conferma il giorno proposto oppure ne sceglie uno tra quelli disponibili e può lasciare un messaggio facoltativo.
...
La risposta non viene conservata in un database: nome, giorno e l’eventuale messaggio vengono inviati direttamente alla chat Telegram configurata.
